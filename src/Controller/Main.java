...
//
//        // Add sample users
        addSecureUser("admin", "qwerty1234" , 5);
        addSecureUser("manager", "qwerty1234", 4);
        addSecureUser("staff", "qwerty1234", 3);
        addSecureUser("client1", "qwerty1234", 2);
        addSecureUser("client2", "qwerty1234", 2);
...
//        // Get users
    ...
    private void addSecureUser(String username, String password, int role) {
        String salt = PasswordUtils.getSalt();
        String hashed = PasswordUtils.hashPassword(password, salt);
        sqlite.addUser(username, hashed, salt, role);
    }
}
